...
LAYERS: dict[str, tuple[str, ...]] = {
    ...
    "memory": (
        ...
        "interchange_propagation", "maintenance_run", "maintenance_run_bindings",
        "maintenance_run_rules", "maintenance_run_state", "metabolism",
    ...
    "harness": (
        ...
        "latent_predictive_state_harness", "locomo_evidence_benchmark",
        "logical_state_algebra_pressure", "long_horizon_benchmark", "long_horizon_dataset",
        "operational_memory_benchmark", "precedent_candidate_harness",
        "retrieval_quality_benchmark", "reusable_grant_harness", "security_evidence_depth",

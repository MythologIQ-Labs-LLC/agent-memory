...
from ..runtime.adapter import Clock, GovernedMemoryAdapter
from ..runtime.projection_governance import ProjectionGovernor
from ..state.substrate import InMemoryTemporalGraph
from ..state.visibility import ABSENCE, VisibilityOperation, VisibilityTracker
...
def deferred_projection(commit: str) -> dict:
    ...
    if not corrected.committed:
        ...
        from ..core.pending_verification import PendingVerificationRegistry
        from ..core.resumption import criteria_for
